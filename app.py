...
## Configuring GEMINI Model for OCR
...
def create_prompt():
    """
    Creates a few shot prompt for Optical character recognition from images.
...
def generate_response(prompt):
    """
    Generate response from gemini model based on the prompt and the given image.
    :param prompt: prompt that should be given to the model
    :return: string: text generated by the model
    """
    try:
...
def get_results(prompts, max_workers = 3):
    """
    Parallel processing to expedite result generation from gemini.
    :param prompts:
    :param max_workers:
    :return:
    """
